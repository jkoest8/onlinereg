...
function checkZipCode() {
    ...
    if (selcoZipCodes.includes(zipCode)) {
        ...
        '<br><br> If you would like to check out physical items from Rochester Public Library, stop in with photo ID and proof of address to upgrade your card!<br><br> Patron could then be emailed their scannable barcode.`
